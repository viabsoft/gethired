...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'action' => Yii::app()->createUrl('employers/account/create'),
...
<?php echo $form->hiddenField($model,'[1]User_Type_Id',array('value'=>2)); ?>
  ...
  'data'=>array('ProvinceId'=>'js:this.value'),
    ...
    'url'=>array('employers/account/create'),
...
<td valign="top">
<?php echo $this->renderPartial('employers.views.default.login_view', array('model'=>$loginmodel)); ?>
</td>
