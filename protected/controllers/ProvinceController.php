...
public function actionLoadcities()
	{
	   $data=Cities::model()->findAll('ProvinceId=:ProvinceId', 
	   array(':ProvinceId'=>(int) $_POST['ProvinceId']));
	...
	{
	   $data=Province::model()->findAll('CountryId=:CountryId', 
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','loadcities','loadprovinces'),
				'users'=>array('*'),
			),
